...
| Reports            | `saved_reports(tenant_id, report_type)`, `scheduled_reports(tenant_id, enabled)`, `report_exports(tenant_id, created_by_id, created_at)`                                                                                                                 | Fast report configuration and export lookups. |
